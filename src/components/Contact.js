...
const Contact = () => {
    return (
        <section id="contact" className="flex flex-col items-center gap-4 max-w-screen-xl m-auto my-auto md:px-32 px-16 py-20 text-base font-semibold min-h-screen justify-center relative">
