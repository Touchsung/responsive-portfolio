...
const Introduction = () => {
    return (
        <header className="flex flex-col gap-4 max-w-screen-xl m-auto my-auto lg:px-32 px-16 py-20 text-base font-semibold min-h-screen justify-center">
            ...
            <h1 className="text-primaryText md:text-6xl font-bold text-5xl">Jettapat Thongsima</h1>
            <h1 className="text-secondaryText md:text-6xl font-bold text-5xl">Now I build things for the web.</h1>
